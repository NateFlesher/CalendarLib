...
- (void)selectDate:(NSDate *)date fromTap:(BOOL)isTapped{
    ...
    if(![self.calendar isDate:date inSameDayAsDate:self.selectedDate]){
        ...
        [self.dayPlannerView scrollToDate:date options:MGCDayPlannerScrollDate animated:YES fromTap:isTapped];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self selectDate:cell.date fromTap:YES];
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    [self selectDate:newDate fromTap:YES];
