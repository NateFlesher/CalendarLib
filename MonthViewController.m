...
- (void)monthPlannerView:(MGCMonthPlannerView*)view didSelectDayCellAtDate:(NSDate*)date{
    if ([self.monthDelegate respondsToSelector:@selector(monthViewController:didSelectDayCellAtDate:)]) {
        [self.monthDelegate monthViewController:self didSelectDayCellAtDate:date];
    }
}
